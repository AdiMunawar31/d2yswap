...
const style = {
	...
	headerLogo: `flex w-1/4 items-center justify-start hover:-rotate-1`,
	nav: `flex-1 flex justify-center items-center ml-[6rem]`,
	...
	return (
		<div className={style.wrapper}>
			<div className={style.headerLogo}>
				<Image src='/images/d2yswap.png' alt='d2yswap' height={40} width={40} />
			</div>
			...
			<div className={style.buttonsContainer}>
				<div className={`${style.button} ${style.buttonPadding} `}>
					<div className={style.buttonIconContainer}>
						<Image src='/images/eth.png' alt='eth logo' height={20} width={20} />
					</div>
					<p>Ethereum</p>
					<div className={style.buttonIconContainer}>
						<AiOutlineDown />
				...
				{currentAccount ? (
					...
					<div onClick={() => connectWallet()} className={`${style.button} px-1`}>
